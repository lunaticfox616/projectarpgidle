...
const HERO_SELECTION_DEFS = {
    ...
    hero4: {
        ...
        label: '블레이드',
        blindLabel: '블레이드',
        talentsText: '카오스 피해 +20%, 흡혈 +1.4%, 이동 속도 +12%, 치명타 피해 +20%, 치명타 확률 +2.5%',
        stats: [{ stat: 'chaosPctDmg', value: 20 }, { stat: 'leech', value: 1.4 }, { stat: 'move', value: 12 }, { stat: 'critDmg', value: 20 }, { stat: 'crit', value: 2.5 }],
...
Object.assign(window, { GEM_SKY_ENHANCEMENTS, TALISMAN_SHAPES, TALISMAN_SHAPE_STYLE, TALISMAN_OPTION_POOL, HERO_SELECTION_DEFS, PASSIVE_TREE, PASSIVE_TARGET_NODES, PASSIVE_DISCOVERY_RADIUS, PASSIVE_ROOT_DISCOVERY_EDGE_DEPTH, PASSIVE_DISCOVERY_EDGE_DEPTH, PASSIVE_PREVIEW_RADIUS, PASSIVE_PREVIEW_EDGE_DEPTH, PASSIVE_THEME_POOLS, PASSIVE_SECTOR_TITLES, PASSIVE_STYLE, PASSIVE_CORE_GENERIC_STATS, PASSIVE_STAR_BLESSING, PASSIVE_APEX_CONFIGS, PASSIVE_SPECIAL_NODE_CONFIGS });
