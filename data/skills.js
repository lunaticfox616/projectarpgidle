...
const SKILL_DB = {
    ...
    '관통 사격': { isGem: true, baseDmg: 1.25, baseSpd: 1.08, leech: 0, crit: 7, dmgScale: 0.07, spdScale: 0.03, ele: 'phys', targetMode: 'pierce', targets: 4, pierceOverkillCarry: true, desc: '적 처치 시 남은 피해량이 다른 적에게 이어지고, 이 피해로도 관통 연쇄가 가능합니다.', tags: ['attack', 'projectile', 'physical'] },
    ...
    ,
    '서리늑대 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'cold', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 빠른 공격 속도를 가진 서리늑대를 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 냉기 피해로 공격합니다. 소환수 전용 스탯만 적용됩니다.', tags: ['summon', 'summon_attack', 'cold'] },
    '불곰 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'fire', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 공격은 느리지만 1타 피해가 강한 불곰을 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 화염 피해로 공격합니다.', tags: ['summon', 'summon_attack', 'fire'] },
    '벼락멧돼지 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'light', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 자체 저항 관통이 높은 벼락멧돼지를 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 번개 피해로 공격합니다.', tags: ['summon', 'summon_attack', 'light'] },
    '칼날까마귀 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'phys', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 치명타 확률과 치명타 피해가 높은 칼날까마귀를 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 물리 피해로 공격합니다.', tags: ['summon', 'summon_attack', 'physical'] },
    '공허 유충 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'chaos', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 카오스 저항 관통에 특화된 공허 유충을 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 카오스 피해로 공격합니다.', tags: ['summon', 'summon_attack', 'chaos'] },
    '벌떼 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'chaos', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 매우 빠르게 공격하는 벌떼를 소환합니다. 플레이어가 직접 공격하는 스킬이 아니며, 소환수가 카오스 피해로 공격합니다.', tags: ['summon', 'summon_attack', 'chaos'] }
};
