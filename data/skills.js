...
const SKILL_DB = {
    ...
    '회오리바람': { isGem: true, baseDmg: 0.34, baseSpd: 1.65, leech: 0, crit: 0, dmgScale: 0.014, spdScale: 0.04, ele: 'phys', targetMode: 'whirl', targets: 6, desc: '근처 적 최대 6기를 회전 방향을 따라 0.1초 간격으로 순차 타격합니다.', tags: ['attack', 'melee', 'physical', 'aoe'] },
