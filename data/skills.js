...
const SKILL_DB = {
    ...
    '화염 참격': { isGem: true, baseDmg: 1.16, baseSpd: 1.05, leech: 0, crit: 5, dmgScale: 0.065, spdScale: 0.02, ele: 'fire', targetMode: 'cleave', targets: 2, ailmentChanceBonus: { ignite: 25 }, activeAilmentDamageMore: { type: 'ignite', pct: 30 }, desc: '점화 확률 +25%. 점화 중인 적에게 주는 적중 피해가 30% 증폭됩니다.', tags: ['attack', 'melee', 'elemental', 'fire'] },
