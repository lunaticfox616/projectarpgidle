...
const SKILL_DB = {
    ...
    ,
    '서리늑대 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'cold', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 전투 시작 시 서리늑대를 소환합니다. 소환수는 플레이어 일반 피해/치명타/공격속도/원소·카오스 피해를 기본 상속하지 않습니다. 소환수 전용 스탯(소환수 피해/생명력/치명타 등)만 적용됩니다.', tags: ['summon', 'summon_attack', 'cold'] },
    '불곰 소환': { isGem: true, baseDmg: 0.1, baseSpd: 1.0, leech: 0, crit: 0, dmgScale: 0, spdScale: 0, ele: 'fire', targetMode: 'single', targets: 1, desc: '공격형 소환수 젬. 전투 시작 시 불곰을 소환합니다. 소환수는 플레이어 일반 공격 능력치를 기본 상속하지 않습니다.', tags: ['summon', 'summon_attack', 'fire'] },
