...
const UNIQUE_DB = [
    ...
    { name: "심연 군주갑", slots: ["갑옷"], reqTier: 6, ultraRare: true, chaseWeight: 5, uniqueEffect: "심연 주얼 슬롯 (1~2)개", uniqueEffectKey: "abyssSocketOnItem", uniqueEffectParams: { min: 1, max: 2 }, stats: [{ id: "flatHp", min: 260, max: 340 }, { id: "dr", min: 12, max: 18 }, { id: "resChaos", min: 20, max: 28 }, { id: 'dotPctDmg', min: 22.7, max: 25.9 }, { id: 'armorPct', min: 30.7, max: 34.9 }] },
    ...
    { name: "황제의 심연띠", slots: ["허리띠"], reqTier: 10, ultraRare: true, chaseWeight: 5, uniqueEffect: "심연 주얼 슬롯 (1~2)개, 장착 심연 주얼 효과 (1~100)% 증가", uniqueEffectKey: "abyssSocketAndJewelAmp", uniqueEffectParams: { socketsMin: 1, socketsMax: 2, ampMin: 1, ampMax: 100 }, stats: [{ id: "flatHp", min: 130, max: 175 }, { id: "pctHp", min: 14, max: 19 }, { id: "dr", min: 6, max: 9 }, { id: "resAll", min: 7, max: 10 }, { id: 'elementalPctDmg', min: 30, max: 34.3 }, { id: 'dotPctDmg', min: 22.7, max: 25.9 }] },
