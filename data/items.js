...
const UNIQUE_DB = [
    ...
    { name: "파편비 시위", slots: ["무기"], reqTier: 8, uniqueEffect: "투사체 젬의 발사 방식을 삼갈래 분산으로 변경 (각 투사체 피해 72%, 창공 각인 우선)", uniqueEffectKey: "projectilePatternMode", uniqueEffectParams: { mode: "split" }, stats: [{ id: "flatDmg", min: 28, max: 38 }, { id: "projectilePctDmg", min: 24, max: 34 }, { id: "projectileExtraShots", min: 1, max: 1 }, { id: "aspd", min: 6, max: 10 }, { id: "crit", min: 4, max: 7 }] },
    { name: "일점 관통기", slots: ["무기"], reqTier: 12, uniqueEffect: "투사체 젬의 발사 방식을 단일 집속으로 변경 (피해 55% 증폭·대상 1명, 창공 각인 우선)", uniqueEffectKey: "projectilePatternMode", uniqueEffectParams: { mode: "focus" }, stats: [{ id: "flatDmg", min: 48, max: 66 }, { id: "projectilePctDmg", min: 34, max: 48 }, { id: "crit", min: 6, max: 10 }, { id: "critDmg", min: 30, max: 45 }, { id: "resPen", min: 7, max: 11 }] },
    { name: "귀로를 새긴 활", slots: ["무기"], reqTier: 16, uniqueEffect: "투사체 젬의 발사 방식을 귀환 궤도로 변경해 왕복 타격 (창공 각인 우선)", uniqueEffectKey: "projectilePatternMode", uniqueEffectParams: { mode: "return" }, stats: [{ id: "flatDmg", min: 72, max: 96 }, { id: "projectilePctDmg", min: 45, max: 62 }, { id: "projectileExtraShots", min: 1, max: 2 }, { id: "leech", min: 1.0, max: 1.6 }, { id: "resPen", min: 8, max: 13 }] },
