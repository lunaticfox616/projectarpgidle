...
const UNIQUE_DB = [
    { name: "첫 계약", slots: ["무기"], reqTier: 1, uniqueEffect: "소환수 최대 한도 +1", uniqueEffectKey: "summonCapBonus", uniqueEffectParams: { cap: 1 }, stats: [{ id: "summonFlatDmg", min: 4, max: 8 }, { id: "summonPctDmg", min: 12, max: 18 }, { id: "summonEfficiency", min: 6, max: 10 }] },
    { name: "무리의 서약", slots: ["무기"], reqTier: 6, uniqueEffect: "소환수 최대 한도 +1", uniqueEffectKey: "summonCapBonus", uniqueEffectParams: { cap: 1 }, stats: [{ id: "summonPctDmg", min: 18, max: 28 }, { id: "summonHpPct", min: 16, max: 24 }, { id: "summonAspd", min: 8, max: 14 }, { id: "resAll", min: 6, max: 10 }] },
    { name: "묘지종 사령홀", slots: ["무기"], reqTier: 10, uniqueEffect: "소환수 사망 시 4초 동안 소환수 피해 +40%", uniqueEffectKey: "summonDeathDamageBuff", uniqueEffectParams: { pct: 40, duration: 4 }, stats: [{ id: "summonHpPct", min: 28, max: 42 }, { id: "summonPctDmg", min: 24, max: 36 }, { id: "summonEfficiency", min: 10, max: 16 }, { id: "resChaos", min: 10, max: 16 }] },
    ...
    { name: "새끼 사역마의 인장", slots: ["반지"], reqTier: 6, uniqueEffect: "소환수 효율 +10%", uniqueEffectKey: "summonEfficiencyBonus", uniqueEffectParams: { pct: 10 }, stats: [{ id: "summonPctDmg", min: 16, max: 24 }, { id: "summonHpPct", min: 16, max: 24 }, { id: "resAll", min: 6, max: 10 }, { id: "leech", min: 0.4, max: 0.8 }] },
    ...
    { name: "찌그러진 생존 방패", slots: ["방패"], reqTier: 1, uniqueEffect: "받는 피해 감소 +2%", uniqueEffectKey: "genericTakenDamageReducePct", uniqueEffectParams: { pct: 2 }, stats: [{ id: "armor", min: 50, max: 80 }, { id: "flatHp", min: 25, max: 40 }, { id: "resAll", min: 3, max: 6 }] },
    { name: "철벽의 심장판", slots: ["방패"], reqTier: 8, uniqueEffect: "막기 확률 +5%", uniqueEffectKey: "uniqueBlockChance", uniqueEffectParams: { chance: 5 }, stats: [{ id: "armor", min: 150, max: 220 }, { id: "armorPct", min: 20, max: 30 }, { id: "flatHp", min: 60, max: 90 }, { id: "dr", min: 5, max: 8 }] },
    { name: "접이식 방패", slots: ["방패"], reqTier: 8, uniqueEffect: "빗겨내기 피해 감소 +5%", uniqueEffectKey: "uniqueDeflectDamageReduce", uniqueEffectParams: { pct: 5 }, stats: [{ id: "evasion", min: 120, max: 200 }, { id: "evasionPct", min: 20, max: 30 }, { id: "deflectChance", min: 5, max: 10 }, { id: "move", min: 6, max: 10 }] },
    ...
    { name: "새벽 현자 후드", slots: ["투구"], reqTier: 1, uniqueEffect: "모든 스킬 젬 레벨 +1", uniqueEffectKey: "uniqueGemLevelBonus", uniqueEffectParams: { level: 1 }, stats: [{ id: "energyShield", min: 45, max: 70 }, { id: "spellFlatPct", min: 8, max: 14 }, { id: "resAll", min: 4, max: 8 }] },
    { name: "맹세의 바르부트", slots: ["투구"], reqTier: 4, uniqueEffect: "받는 피해 감소 +3%", uniqueEffectKey: "genericTakenDamageReducePct", uniqueEffectParams: { pct: 3 }, stats: [{ id: "armor", min: 70, max: 110 }, { id: "energyShield", min: 60, max: 100 }, { id: "flatHp", min: 35, max: 55 }, { id: "resAll", min: 6, max: 10 }] },
    ...
    { name: "철면피", slots: ["투구"], reqTier: 9, uniqueEffect: "출혈에 면역", uniqueEffectKey: "immuneBleed", stats: [{ id: "armor", min: 130, max: 190 }, { id: "armorPct", min: 18, max: 28 }, { id: "flatHp", min: 50, max: 80 }, { id: "dr", min: 4, max: 7 }] },
    { name: "생존자의 외투", slots: ["갑옷"], reqTier: 1, uniqueEffect: "적 1명일 때 받는 피해 감소 +4%", uniqueEffectKey: "uniqueTakenReduceWhen1Enemy", uniqueEffectParams: { pct: 4 }, stats: [{ id: "evasion", min: 40, max: 100 }, { id: "flatHp", min: 40, max: 65 }, { id: "move", min: 4, max: 7 }] },
    { name: "어느 성전사의 낡은 판금", slots: ["갑옷"], reqTier: 4, uniqueEffect: "생명력의 10%만큼을 에너지 보호막으로 획득", uniqueEffectKey: "lifePctAsEnergyShield", uniqueEffectParams: { pct: 10 }, stats: [{ id: "armor", min: 120, max: 180 }, { id: "energyShield", min: 90, max: 140 }, { id: "resAll", min: 7, max: 12 }, { id: "dr", min: 3, max: 5 }] },
    ...
    { name: "숨은 칼날 장갑", slots: ["장갑"], reqTier: 1, uniqueEffect: "최소 피해 보정 +5%", uniqueEffectKey: "uniqueMinDmgRoll", uniqueEffectParams: { pct: 5 }, stats: [{ id: "aspd", min: 8, max: 12 }, { id: "evasion", min: 35, max: 60 }, { id: "crit", min: 2, max: 4 }] },
    { name: "보호장갑", slots: ["장갑"], reqTier: 4, uniqueEffect: "막기 확률 +4%", uniqueEffectKey: "uniqueBlockChance", uniqueEffectParams: { chance: 4 }, stats: [{ id: "armor", min: 55, max: 90 }, { id: "energyShield", min: 45, max: 80 }, { id: "resAll", min: 5, max: 9 }, { id: "dr", min: 2, max: 4 }] },
    ...
    { name: "헝겊 순례자", slots: ["신발"], reqTier: 1, uniqueEffect: "경험치 획득 +5%", uniqueEffectKey: "xpGainPct", uniqueEffectParams: { pct: 5 }, stats: [{ id: "move", min: 12, max: 16 }, { id: "energyShield", min: 35, max: 60 }, { id: "regen", min: 0.5, max: 0.9 }] },
    { name: "추적자", slots: ["신발"], reqTier: 4, uniqueEffect: "적 한도에 의해 이동이 막히지 않음", uniqueEffectKey: "noCollisionBlock", stats: [{ id: "move", min: 14, max: 20 }, { id: "evasion", min: 70, max: 110 }, { id: "energyShield", min: 60, max: 100 }, { id: "resPen", min: 3, max: 5 }] },
    ...
    { name: "초월자 파쇄검", slots: ["무기"], reqTier: 1, ultraRare: true, uniqueEffect: "플레이어 레벨 1당 기본 피해 +10", uniqueEffectKey: "flatDmgPerLevel", uniqueEffectParams: { perLevel: 10 }, stats: [{ id: "flatDmg", min: 32, max: 42 }, { id: "critDmg", min: 55, max: 75 }, { id: "aspd", min: 11, max: 15 }] },
    { name: "새벽의 약속", slots: ["투구"], reqTier: 6, ultraRare: true, uniqueEffect: "경험치 획득량 +10%", uniqueEffectKey: "xpGainPct", uniqueEffectParams: { pct: 10 }, stats: [{ id: "flatHp", min: 90, max: 120 }, { id: "resAll", min: 12, max: 17 }, { id: "resChaos", min: 12, max: 17 }, { id: "regen", min: 1.0, max: 1.5 }] },
    ...
    { name: "폭풍 추적자", slots: ["신발"], reqTier: 6, ultraRare: true, uniqueEffect: "플레이어가 받는 감전 효과 반전 (피해 증가 → 피해 감소)", uniqueEffectKey: "invertShockTaken", stats: [{ id: "move", min: 17, max: 22 }, { id: "aspd", min: 9, max: 12 }, { id: "resL", min: 14, max: 19 }] },
    ...
    { name: "황제의 심연띠", slots: ["허리띠"], reqTier: 10, ultraRare: true, uniqueEffect: "심연 주얼 슬롯 (1~2)개, 장착 심연 주얼 효과 (1~100)% 증가", uniqueEffectKey: "abyssSocketAndJewelAmp", uniqueEffectParams: { socketsMin: 1, socketsMax: 2, ampMin: 1, ampMax: 100 }, stats: [{ id: "flatHp", min: 130, max: 175 }, { id: "pctHp", min: 14, max: 19 }, { id: "dr", min: 6, max: 9 }, { id: "resAll", min: 7, max: 10 }] },
    ...
    { name: "만상 관통석", slots: ["목걸이"], reqTier: 10, ultraRare: true, stats: [{ id: "resPen", min: 9, max: 13 }, { id: "elementalPctDmg", min: 20, max: 29 }, { id: "resAll", min: 10, max: 10 }, { id: "gemLevel", min: 1, max: 2 }] },
    { name: "천공 붕괴자", slots: ["무기"], reqTier: 10, ultraRare: true, uniqueEffect: "이 무기는 항상 감전 부여", uniqueEffectKey: "alwaysShock", stats: [{ id: "flatDmg", min: 55, max: 72 }, { id: "lightPctDmg", min: 24, max: 33 }, { id: "critDmg", min: 60, max: 80 }, { id: "shockEffect", min: 50, max: 50 }] },
    { name: "폭우의 석궁", slots: ["무기"], reqTier: 11, ultraRare: true, stats: [{ id: "flatDmg", min: 44, max: 59 }, { id: "projectilePctDmg", min: 31, max: 43 }, { id: "projectileExtraShots", min: 1, max: 2 }, { id: "projectileExtraShots", min: 1, max: 2 }] },
    ...
    { name: "성좌의 주문핵", slots: ["무기"], reqTier: 11, ultraRare: true, stats: [{ id: "spellFlatDmg", min: 36, max: 54 }, { id: "spellFlatPct", min: 14, max: 21 }, { id: "spellCritDmg", min: 35, max: 35 }, { id: "gemLevel", min: 1, max: 1 }] },
    ...
    { name: "황혼의 왕관", slots: ["투구"], reqTier: 10, ultraRare: true, uniqueEffect: "에너지 보호막 50% 전역 증폭, 치명타 시 최대 ES의 2% 즉시 회복", uniqueEffectKey: "esAmpAndRecoverOnCrit", uniqueEffectParams: { ampPct: 50, recoverPctOnCrit: 2 }, stats: [{ id: "crit", min: 10, max: 14 }, { id: "critDmg", min: 45, max: 62 }, { id: "resAll", min: 10, max: 14 }] },
    ...
    { name: "굶주린 톱니", slots: ["반지"], reqTier: 12, uniqueEffect: "적 처치 시 8초간 모든 흡혈 효율 +100% (중첩 불가, 갱신형)", uniqueEffectKey: "leechEfficiencyOnKill", uniqueEffectParams: { duration: 8, efficiencyPct: 100 }, stats: [{ id: "leech", min: 1.2, max: 1.8 }, { id: "minDmgRoll", min: 4, max: 7 }, { id: "chaosPctDmg", min: 20, max: 30 }] },
    ...
    { name: "지평선 분할자", slots: ["무기"], reqTier: 13, uniqueEffect: "적 처치 시 초과 피해를 주변 적에게 전달", uniqueEffectKey: "overkillSplash", stats: [{ id: "flatDmg", min: 44, max: 60 }, { id: "minDmgRoll", min: 8, max: 12 }, { id: "maxDmgRoll", min: 8, max: 12 }] },
    { name: "용맥 수호", slots: ["장갑"], reqTier: 13, uniqueEffect: "타격 시 20% 확률로 2초간 수호(최대생명력 8% 보호막, 중첩 불가)", uniqueEffectKey: "dragonVeinGuard", uniqueEffectParams: { chance: 20, duration: 2, hpPct: 8 }, stats: [{ id: "flatHp", min: 70, max: 100 }, { id: "regen", min: 0.9, max: 1.4 }, { id: "minDmgRoll", min: 5, max: 9 }] },
    { name: "운명의 쌍현", slots: ["목걸이"], reqTier: 14, uniqueEffect: "최소/최대 피해 보정을 높은 값으로 통일, 치확의 20%만큼 추가 상승", uniqueEffectKey: "fateTwinRollSync", uniqueEffectParams: { critToRollPct: 20 }, stats: [{ id: "minDmgRoll", min: 7, max: 11 }, { id: "maxDmgRoll", min: 7, max: 11 }, { id: "crit", min: 8, max: 12 }] },
    ...
    { name: "빙결파수 장화", slots: ["신발"], reqTier: 12, uniqueEffect: "냉각/동결 면역, 냉각 효율 +50%", uniqueEffectKey: "frostSentinelBoots", uniqueEffectParams: { chillEffectPct: 50 }, stats: [{ id: "move", min: 15, max: 21 }, { id: "resC", min: 20, max: 28 }, { id: "energyShield", min: 80, max: 130 }, { id: "regen", min: 0.8, max: 1.3 }] },
    { name: "감전추적 경갑", slots: ["신발"], reqTier: 13, uniqueEffect: "감전 면역, 감전 효율 +25%, 감전 적 타격 시 번개 낙뢰(내부쿨 0.5초)", uniqueEffectKey: "shockTracerGreaves", uniqueEffectParams: { shockEffectPct: 25, strikeDamagePct: 500, icdSec: 0.5 }, stats: [{ id: "move", min: 18, max: 24 }, { id: "resL", min: 20, max: 30 }, { id: "aspd", min: 10, max: 15 }, { id: "crit", min: 6, max: 10 }] },
    { name: "독기 유영화", slots: ["신발"], reqTier: 14, uniqueEffect: "중독 피해 배율 +30%, 중독 최대 중첩 +1", uniqueEffectKey: "venomStride", uniqueEffectParams: { poisonMorePct: 30, poisonExtraStack: 1 }, stats: [{ id: "move", min: 16, max: 22 }, { id: "resChaos", min: 18, max: 28 }, { id: "leech", min: 1.0, max: 1.6 }, { id: "chaosPctDmg", min: 20, max: 30 }] },
    { name: "출혈 봉쇄 투구", slots: ["투구"], reqTier: 12, uniqueEffect: "출혈 면역, 받는 물리 피해의 15%를 카오스 피해로 전환", uniqueEffectKey: "bleedBlockHelm", uniqueEffectParams: { physToChaosTakenPct: 15 }, stats: [{ id: "flatHp", min: 72, max: 98 }, { id: "dr", min: 7, max: 11 }, { id: "resAll", min: 10, max: 16 }, { id: "regen", min: 1.0, max: 1.5 }] },
    { name: "저주의 관", slots: ["투구"], reqTier: 13, uniqueEffect: "저주 최대치 +1, 적에게 걸린 저주 1개당 최종 피해 +6%", uniqueEffectKey: "curseCrown", uniqueEffectParams: { extraCurseCap: 1, finalDmgPerCursePct: 6 }, stats: [{ id: "chaosPctDmg", min: 20, max: 30 }, { id: "resPen", min: 8, max: 14 }, { id: "crit", min: 6, max: 10 }, { id: "resChaos", min: 10, max: 16 }] },
    { name: "수호 성갑", slots: ["갑옷"], reqTier: 14, uniqueEffect: "받는 피해 -8%, 보스에게 받는 피해 -12%", uniqueEffectKey: "guardianArmor", uniqueEffectParams: { takenLessPct: 8, bossTakenLessPct: 12 }, stats: [{ id: "flatHp", min: 140, max: 200 }, { id: "dr", min: 10, max: 14 }, { id: "resAll", min: 14, max: 20 }, { id: "regen", min: 1.4, max: 2.2 }] },
    { name: "함성 공명 허리띠", slots: ["허리띠"], reqTier: 13, uniqueEffect: "플레이어에게 적용된 함성 1개당 피해 20% 증폭", uniqueEffectKey: "warcryResonanceBelt", uniqueEffectParams: { perWarcryAmpPct: 20 }, stats: [{ id: "flatHp", min: 90, max: 130 }, { id: "move", min: 8, max: 14 }, { id: "aspd", min: 8, max: 12 }, { id: "resAll", min: 8, max: 14 }] },
    { name: "저항 잠식 반지", slots: ["반지"], reqTier: 12, uniqueEffect: "동일 대상 연속 타격 시 원소저항 -2% 누적 (최대 -20%)", uniqueEffectKey: "stackingElementalResDownOnHit", uniqueEffectParams: { perHit: 2, max: 20 }, stats: [{ id: "resPen", min: 10, max: 16 }, { id: "elementalPctDmg", min: 18, max: 28 }, { id: "resAll", min: 8, max: 14 }, { id: "leech", min: 0.8, max: 1.3 }] },
    { name: "컨디션 교본", slots: ["목걸이"], reqTier: 14, uniqueEffect: "컨디션 젬 지속시간 +100%, 쿨다운 회복 속도 +20%", uniqueEffectKey: "conditionManual", uniqueEffectParams: { durationPct: 100, cdrPct: 20 }, stats: [{ id: "gemLevel", min: 2, max: 2 }, { id: "suppCap", min: 1, max: 1 }, { id: "regen", min: 1.1, max: 1.7 }, { id: "resAll", min: 10, max: 16 }] },

    { name: "벌집 여왕의 명령", slots: ["투구"], reqTier: 12, dropOnly: { type: 'beehive' }, uniqueEffect: "타격 시 8% 확률로 벌 소환(최대 10마리)", uniqueEffectKey: "queenBeeSummonOnHit", uniqueEffectParams: { chance: 8, hitPct: 125, intervalSec: 1, attacks: 3, maxBees: 10 }, stats: [{ id: "flatHp", min: 68, max: 96 }, { id: "evasion", min: 90, max: 140 }, { id: "venomStingerBonus", min: 8, max: 14 }, { id: "resChaos", min: 12, max: 18 }] },
    { name: "시련 심판자의 장갑", slots: ["장갑"], reqTier: 15, dropOnly: { type: 'trial' }, uniqueEffect: "출혈 중인 적 타격 시 출혈 피해 2배", uniqueEffectKey: "bleedWeightOnBleedingHit", stats: [{ id: "aspd", min: 12, max: 18 }, { id: "dr", min: 4, max: 7 }, { id: "armor", min: 70, max: 120 }, { id: "critDmg", min: 20, max: 34 }] },
    { name: "대균열의 왕관", slots: ["투구"], reqTier: 17, dropOnly: { id: 'grand_breach_run' }, uniqueEffect: "주문 내장 피해 +최대ES의 10%, 에너지 보호막 +30%", uniqueEffectKey: "grandBreachCrown", uniqueEffectParams: { spellFromEsPct: 10, esPct: 30 }, stats: [{ id: "energyShield", min: 110, max: 170 }, { id: "resPen", min: 8, max: 14 }, { id: "resAll", min: 10, max: 16 }] },
    { name: "미궁 군주의 족쇄", slots: ["신발"], reqTier: 20, dropOnly: { type: 'labyrinth', minFloor: 30 }, uniqueEffect: "이동 속도 100% 고정, 감소된 이속만큼 피해 증가", uniqueEffectKey: "labyrinthShackles", stats: [{ id: "move", min: 18, max: 24 }, { id: "armor", min: 110, max: 160 }, { id: "dr", min: 4, max: 8 }, { id: "resAll", min: 10, max: 16 }] },
    { name: "낙성의 발자취", slots: ["신발"], reqTier: 19, dropOnly: { type: 'meteor' }, uniqueEffect: "치명타 적중 시 20% 확률로 소형 운석 낙하", uniqueEffectKey: "meteorFootsteps", uniqueEffectParams: { chance: 20, damagePct: 180 }, stats: [{ id: "move", min: 18, max: 24 }, { id: "evasion", min: 120, max: 180 }, { id: "crit", min: 6, max: 10 }, { id: "lightPctDmg", min: 16, max: 26 }] },
