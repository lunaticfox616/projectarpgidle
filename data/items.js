...
const COSMOS_CODEX = [
    { name: '잿불의 인장', key: 'realmAllResDownOnHit', params: { perHit: 5, max: 4, duration: 5 }, desc: '타격마다 적의 모든 저항 −5%(최대 4중첩, 5초 지속)' },
    { name: '빗발치는 화살', key: 'projectileDoubleStrikePct', params: { pct: 40 }, desc: '투사체가 40% 확률로 한 번 더 적중' },
    { name: '무너지지 않는 둑', key: 'genericTakenDamageReducePct', params: { pct: 10 }, desc: '받는 모든 피해 10% 추가 감소' },
    { name: '쌍둥이 운명', key: 'fateTwinRollSync', params: { critToRollPct: 18 }, desc: '피해 보정을 높은 값으로 통일하고, 치명타 확률의 18%만큼 추가 상승' },
    ...
    { name: '질주의 발자국', key: 'realmKillMoveStacks', params: { movePerStack: 10, maxStacks: 20, duration: 20, cooldownSec: 1 }, desc: '적 처치 시 이동 속도 +10%(최대 20중첩, 20초)' },
    { name: '여왕벌의 둥지', key: 'queenBeeSummonOnHit', params: { chance: 8, hitPct: 125, attacks: 3, maxBees: 10 }, desc: '타격 시 8% 확률로 여왕벌 소환(공격력의 125%로 3회 공격, 최대 10마리)' },
    { name: '정점의 일격', key: 'ceilingSmashDouble', params: {}, desc: '피해를 140% 이상으로 굴리면 15% 확률로 2배 피해' },
    ...
    { name: '갈래진 화살', key: 'projectileTargetBonus', params: { target: 2 }, desc: '투사체가 추가로 2명을 더 타격' },
    ...
    { name: '최대치의 손길', key: 'maxRollBonusHit', params: {}, desc: '최대 피해로 굴릴 때 보너스 타격이 추가됨' },
    ...
    { name: '시체밭의 봉인', key: 'corpseExplodeOnKill', params: { chance: 16, lifePct: 22 }, desc: '처치 시 16% 확률로 시체 폭발(최대 생명력의 22%)' },
    { name: '끊어진 회복', key: 'realmEnemyRegenCutAndMinRoll', params: { enemyRegenRateMul: 0.5, minRoll: 10 }, desc: '적의 생명력 재생 50% 감소, 최소 피해 보정 +10%' },
    ...
    { name: '외로운 사냥', key: 'uniqueTakenReduceWhen1Enemy', params: { pct: 18 }, desc: '적이 1명일 때 받는 피해 18% 감소' },
    ...
    { name: '깨어난 보석', key: 'uniqueGemLevelBonus', params: { level: 1 }, desc: '모든 스킬 젬 레벨 +1' },
    { name: '사냥개의 송곳니', key: 'summonCritAspdStacks', params: { aspd: 10, maxStacks: 3, duration: 4 }, desc: '소환수가 치명타 적중 시 공격 속도 +10%(최대 3중첩, 4초)' },
    { name: '마르지 않는 샘', key: 'realmRegenRateAndRegen', params: { regenRatePct: 25, regen: 2 }, desc: '생명력 재생 속도 +25%, 생명력 재생 +2%' },
    { name: '비껴내는 손목', key: 'uniqueDeflectDamageReduce', params: { pct: 20 }, desc: '비껴내기 시 받는 피해 20% 추가 감소' },
    ...
    { name: '스쳐가는 그림자', key: 'noCollisionBlock', params: {}, desc: '적과 충돌하지 않고 통과하며 막기 효과를 얻음' },
    { name: '피로 새긴 맹세', key: 'hpToPhysPct', params: {}, desc: '물리 스킬의 기본 피해가 최대 생명력 100당 +1% 증가' },
    { name: '군세의 부름', key: 'summonCapBonus', params: { cap: 1 }, desc: '소환수 한도 +1' },
    { name: '감전된 표적', key: 'hitShockedEnemyDamageMorePct', params: { pct: 50 }, desc: '감전된 적에게 주는 피해 +50%' },
    { name: '충직한 군대', key: 'summonEfficiencyBonus', params: { pct: 15 }, desc: '소환 효율 +15%' },
