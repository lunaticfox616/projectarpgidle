...
const UNIQUE_DB = [
    ...
    { name: "파편비 시위", slots: ["무기"], reqTier: 8, uniqueEffect: "투사체 젬을 삼갈래로 분산. 스킬 피해 10% 감폭, 보조 방향은 45% 피해 (창공 각인 우선)", uniqueEffectKey: "projectilePatternMode", uniqueEffectParams: { mode: "split", damageMultiplier: 0.9 }, stats: [{ id: "flatDmg", min: 28, max: 38 }, { id: "projectilePctDmg", min: 24, max: 34 }, { id: "projectileExtraShots", min: 1, max: 1 }, { id: "aspd", min: 6, max: 10 }, { id: "crit", min: 4, max: 7 }] },
    ...
    { name: "귀로를 새긴 활", slots: ["무기"], reqTier: 16, uniqueEffect: "투사체 젬이 관통 후 귀환. 왕복 타격은 각각 50% 피해 (창공 각인 우선)", uniqueEffectKey: "projectilePatternMode", uniqueEffectParams: { mode: "return", damageMultiplier: 1 }, stats: [{ id: "flatDmg", min: 72, max: 96 }, { id: "projectilePctDmg", min: 45, max: 62 }, { id: "projectileExtraShots", min: 1, max: 2 }, { id: "leech", min: 1.0, max: 1.6 }, { id: "resPen", min: 8, max: 13 }] },
