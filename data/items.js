...
const UNIQUE_DB = [
    ...
    { name: "군무의 베일", slots: ["투구"], reqTier: 10, uniqueEffect: "생존한 적이 6명 이상이면 회피 60% 증폭", uniqueEffectKey: "crowdEvasionMore", uniqueEffectParams: { minEnemies: 6, morePct: 60 }, stats: [{ id: "evasion", min: 160, max: 240 }, { id: "evasionPct", min: 28, max: 40 }, { id: "move", min: 10, max: 16 }, { id: "deflectChance", min: 5, max: 8 }, { id: "resAll", min: 10, max: 16 }] },
    { name: "고독한 잔상", slots: ["갑옷"], reqTier: 14, uniqueEffect: "생존한 적이 1~2명이면 회피 45% 증폭", uniqueEffectKey: "fewEnemyEvasionMore", uniqueEffectParams: { minEnemies: 1, maxEnemies: 2, morePct: 45 }, stats: [{ id: "evasion", min: 260, max: 380 }, { id: "evasionPct", min: 34, max: 48 }, { id: "move", min: 12, max: 18 }, { id: "flatHp", min: 80, max: 120 }, { id: "resAll", min: 12, max: 18 }] },
    { name: "영점 장갑", slots: ["장갑"], reqTier: 12, uniqueEffect: "에너지 보호막 20% 전역 증폭, 치명타 시 최대 ES의 3% 즉시 회복", uniqueEffectKey: "esAmpAndRecoverOnCrit", uniqueEffectParams: { ampPct: 20, recoverPctOnCrit: 3 }, stats: [{ id: "energyShield", min: 110, max: 160 }, { id: "energyShieldPct", min: 24, max: 36 }, { id: "energyShieldRegen", min: 8, max: 14 }, { id: "crit", min: 6, max: 10 }, { id: "critDmg", min: 20, max: 32 }] },
    { name: "별을 품은 살갗", slots: ["갑옷"], reqTier: 16, uniqueEffect: "최대 생명력의 15%만큼 에너지 보호막을 추가로 획득", uniqueEffectKey: "lifePctAsEnergyShield", uniqueEffectParams: { pct: 15 }, stats: [{ id: "energyShield", min: 220, max: 320 }, { id: "energyShieldPct", min: 34, max: 48 }, { id: "pctHp", min: 12, max: 18 }, { id: "resAll", min: 12, max: 18 }, { id: "resChaos", min: 12, max: 18 }] },
