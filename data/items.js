...
const UNIQUE_DB = [
    ...
    { name: "공허 제국의 인장", slots: ["반지"], reqTier: 10, ultraRare: true, uniqueEffect: "타격 시 적 카오스 저항 -3% (최대 10중첩)", uniqueEffectKey: "hitApplyChaosResDown", uniqueEffectParams: { perHit: 3, maxStacks: 10 }, stats: [{ id: "resAll", min: 17, max: 22 }, { id: "crit", min: 9, max: 12 }, { id: "chaosPctDmg", min: 45, max: 65 }, { id: "leech", min: 0.9, max: 1.4 }, { id: "resPen", min: 8, max: 14 }] },
    ...
    { name: "저항 잠식 반지", slots: ["반지"], reqTier: 12, uniqueEffect: "동일 대상 연속 타격 시 원소저항 -2% 누적 (최대 -20%)", uniqueEffectKey: "stackingElementalResDownOnHit", uniqueEffectParams: { perHit: 2, max: 20 }, stats: [{ id: "resPen", min: 10, max: 16 }, { id: "chaosPctDmg", min: 18, max: 28 }, { id: "resAll", min: 8, max: 14 }, { id: "leech", min: 0.8, max: 1.3 }] },
