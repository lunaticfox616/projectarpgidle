...
const GROWTH_UNIQUE_DB = [
    ...
    { name: '재의 태양', baseId: 'gf_ember_crown', reqTier: 11,
      ...
      stats: [{ id: 'firePctDmg', min: 14, max: 14 }, { id: 'igniteChance', min: 12, max: 12 }],
      tags: ['화염', '상태이상', '중심'] },
    { name: '첫 수확의 성배', baseId: 'gfr_red_berry', reqTier: 12,
      ...
      stats: [{ id: 'crit', min: 4, max: 4 }, { id: 'critDmg', min: 14, max: 14 }],
      tags: ['수확', '치명타', '성장'] },
    { name: '거꾸로 자란 뿌리', baseId: 'gr_ancient_buttress', reqTier: 14,
      ...
      stats: [{ id: 'flatHp', min: 32, max: 32 }, { id: 'armor', min: 70, max: 70 }],
      tags: ['방어', '고목', '역행'] },
    { name: '피의 십일조', baseId: 'gt_blood_thorn', reqTier: 12,
      ...
      stats: [{ id: 'physPctDmg', min: 12, max: 12 }, { id: 'leech', min: 0.5, max: 0.5 }],
      tags: ['물리', '흡혈', '희생'] },
    { name: '폭풍을 꿰는 도관', baseId: 'gst_hollow_conduit', reqTier: 14,
      ...
      stats: [{ id: 'aspd', min: 8, max: 8 }, { id: 'lightPctDmg', min: 14, max: 14 }],
      tags: ['연결', '공명', '번개'] },
    { name: '군체의 탯줄', baseId: 'gv_canopy_bridge', reqTier: 15,
      ...
      stats: [{ id: 'summonPctDmg', min: 18, max: 18 }, { id: 'summonHpPct', min: 15, max: 15 }],
      tags: ['연결', '소환수', '군체'] },
