...
const GROWTH_AFFIX_VALUE_DB = Object.freeze({
    ...
    weaponPhysFlatDmg: { base: 1.2, step: 1.2 }, weaponFireFlatDmg: { base: 1.3, step: 1.3 },
    weaponColdFlatDmg: { base: 1.3, step: 1.3 }, weaponLightFlatDmg: { base: 1.3, step: 1.3 },
    weaponChaosFlatDmg: { base: 1.2, step: 1.2 }, ringPhysFlatDmg: { base: 0.55, step: 0.5 },
    ringFireFlatDmg: { base: 0.55, step: 0.5 }, ringColdFlatDmg: { base: 0.55, step: 0.5 },
    ringLightFlatDmg: { base: 0.55, step: 0.5 }, ringChaosFlatDmg: { base: 0.55, step: 0.5 },
    glovePhysFlatDmg: { base: 0.55, step: 0.5 }, gloveFireFlatDmg: { base: 0.55, step: 0.5 },
    gloveColdFlatDmg: { base: 0.55, step: 0.5 }, gloveLightFlatDmg: { base: 0.55, step: 0.5 },
    gloveChaosFlatDmg: { base: 0.55, step: 0.5 },
