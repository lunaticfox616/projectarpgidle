...
const BOUNTY_HUNT_CONFIG = Object.freeze({
    ...
    riskHpStep:0.1, riskDamageStep:0.05, riskRewardStep:0.1, riskRareStep:0.15,
...
const BOUNTY_TARGET_DB = Object.freeze({
    iron_collector: Object.freeze({
        id: 'iron_collector', icon: '🛡️', name: '철갑 수집가', risk:1, danger: '생명력·방어도·피해 감소 강화',
    ...
    storm_smuggler: Object.freeze({
        id: 'storm_smuggler', icon: '⚡', name: '폭풍 밀매상', risk:2, danger: '공격 속도·관통·번개 피해 강화',
    ...
    root_poacher: Object.freeze({
        id: 'root_poacher', icon: '🌿', name: '뿌리 밀렵꾼', risk:1, unlockLoop: 25, danger: '생명력 재생·회복·방어 강화',
    ...
    glass_executioner: Object.freeze({
        id: 'glass_executioner', icon: '🗡️', name: '유리칼 처형자', risk:3, danger: '낮은 생명력·극단적인 피해와 치명타',
    ...
    chaos_broker: Object.freeze({
        id: 'chaos_broker', icon: '☠️', name: '혼돈 중개상', risk:3, danger: '카오스 저항·관통·공격 피해 강화',
    ...
    mirror_runner: Object.freeze({
        id: 'mirror_runner', icon: '◆', name: '거울 갑주 도주자', risk:2, danger: '회피·첫 타격 보호·공격 속도 강화',
