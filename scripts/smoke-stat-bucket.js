...
assert.deepEqual([b.targetAny, b.critDmg, b.leech], [2, 0, 0]);
assert.deepEqual([b.spellCritDmg, b.spellLeech], [15, 0.5], 'spell-only stats must not leak into attack stats');
