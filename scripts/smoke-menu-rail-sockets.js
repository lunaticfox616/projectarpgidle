...
vm.runInContext([
    ...
    readFunctionSource(uiSource, 'isJournalTabUnlockReady'),
    readFunctionSource(uiSource, 'isMergedTabAvailable'),
    readFunctionSource(uiSource, 'getMergedTabGroup'),
    readFunctionSource(uiSource, 'getSelectedMergedTabId'),
    readFunctionSource(uiSource, 'isTabSurfaceAvailable'),
    readFunctionSource(uiSource, 'closeRelockedTabSurfaces'),
