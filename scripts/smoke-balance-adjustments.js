...
assert.strictEqual(marketContext.isUniqueEligibleForBlackMarket({ name: '운명의 쌍현', dropOnly: { type: 'cosmos' } }), false, 'cosmos-only uniques must be excluded from the black market');
