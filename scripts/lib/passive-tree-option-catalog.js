...
const STAT_META = Object.freeze({
    ...
    resPen: ['저항 관통', '%'], resAll: ['모든 원소 저항', '%'], resChaos: ['카오스 저항', '%'],
...
const ARCHETYPE_PROFILES = Object.freeze({
    ...
    armor: Object.freeze([
        ...
        profile('충격 분산', line('armorPct', 4), line('dr', 1, { majorOnly: true }))
    ]),
