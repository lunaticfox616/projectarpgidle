...
const LOAD_ORDER = [
    'data/constants.js', 'data/bounties.js', 'data/maps.js', 'data/skills.js', 'data/items.js', 'data/offline-progress.js',
    ...
    'js/canvas-attack-fx.js', 'js/canvas-passive-tree.js', 'js/bounty-ui.js', 'js/ui.js', 'js/growth-ui.js',
