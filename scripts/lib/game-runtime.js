...
const LOAD_ORDER = [
    'data/constants.js', 'data/shrines.js', 'data/maps.js', 'data/skills.js', 'data/severed-wanderers.js', 'data/items.js', 'data/offline-progress.js',
    ...
    'js/growth-generation.js', 'js/core-cube.js', 'js/combat-grid.js', 'js/severed-wanderers.js',
    'js/combat-patterns.js', 'js/combat.js', 'js/combat-ehp.js', 'js/equipment-triage.js', 'js/canvas-battlefield.js',
    'js/canvas-attack-fx.js', 'js/canvas-passive-tree.js', 'js/crafting-result-ui.js', 'js/ui.js', 'js/salvage-recovery-ui.js', 'js/unique-hunt-ui.js', 'js/equipment-loadouts-ui.js', 'js/growth-ui.js',
