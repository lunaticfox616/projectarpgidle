...
const LOAD_ORDER = [
    'data/constants.js', 'data/level-progression.js', 'data/build-stat-inputs.js', 'data/shrines.js', 'data/maps.js', 'data/story-journal.js', 'data/act-exploration-maps.js', 'data/cosmos-route.js', 'data/world-tree-journey.js', 'data/gem-core-forge.js', 'data/skills.js', 'data/skill-fx-atlas.js', 'data/endgame-progression.js', 'data/severed-wanderers.js', 'data/items.js', 'data/unique-equipment.js', 'data/offline-progress.js',
    ...
    'data/talent-cards.js', 'data/content-progression.js', 'data/hotkeys.js',
...
'js/canvas-attack-fx.js', 'js/canvas-passive-tree.js', 'js/equipment-inventory-grid-ui.js', 'js/equipment-inspection-ui.js', 'js/crafting-result-ui.js', 'js/loop-ui.js', 'js/flask-ui.js', 'js/passive-selection-ui.js', 'js/arcana-mobile-ui.js', 'js/endgame-progression-ui.js', 'js/tutorial-ui.js', 'js/story-journal-ui.js', 'js/inventory-search-ui.js', 'js/colony-ward-ui.js', 'js/ui-panel-markup.js', 'js/underworld-rune-ui.js', 'js/tab-layout-ui.js', 'js/fossil-workbench-ui.js', 'js/chaos-infuser-ui.js', 'js/ocean-collection-ui.js', 'js/sea-gift-ui.js', 'js/level-progression-ui.js', 'js/crafting-goal-options.js', 'js/crafting-catalog-ui.js', 'js/crafting-workspace-ui.js', 'js/ui.js', 'js/market-ui.js', 'js/equipment-loot-ui.js', 'js/content-progression-ui.js', 'js/salvage-recovery-ui.js', 'js/unique-hunt-ui.js', 'js/equipment-loadouts-ui.js', 'js/growth-ui.js',
    ...
    'js/cosmos-route-ui.js', 'js/world-tree-journey-ui.js', 'js/exploration-atlas-ui.js', 'js/canvas-side-encounters.js', 'js/side-encounter-ui.js', 'js/save-migrations.js', 'js/build-feedback-ui.js', 'js/combat-replay.js', 'js/main.js'
];
...
function buildGameRuntime(sourceOverrides = {}, eventTarget = null, documentOverrides = {}) {
    ...
    const makeEl = () => ({
        ...
        setAttribute: noop, getAttribute: () => null, removeAttribute: noop, toggleAttribute: noop,
