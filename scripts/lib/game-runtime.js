...
const LOAD_ORDER = [
    ...
    'js/utils.js', 'js/ui-feedback.js', 'js/state.js', 'js/endgame-progression.js', 'js/salvage-recovery.js', 'js/unique-hunt.js', 'js/offline-progress.js', 'js/records.js', 'js/save.js', 'js/items.js', 'js/equipment-loadouts.js', 'js/equipment-inventory-grid.js',
    ...
    'js/canvas-attack-fx.js', 'js/canvas-passive-tree.js', 'js/equipment-inventory-grid-ui.js', 'js/crafting-result-ui.js', 'js/bounty-ui.js', 'js/loop-ui.js', 'js/endgame-progression-ui.js', 'js/ui.js', 'js/salvage-recovery-ui.js', 'js/unique-hunt-ui.js', 'js/equipment-loadouts-ui.js', 'js/growth-ui.js',
