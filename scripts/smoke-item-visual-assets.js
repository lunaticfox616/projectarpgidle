...
assert.strictEqual(resolve({ slot: '허리띠' }, 'equipment'), 'assets/items/engraved-belt-v3.png?v=20260821-1');
assert.strictEqual(resolve({ slot: '반지' }, 'equipment'), 'assets/items/ruby-ring-v3.png?v=20260821-1');
