...
const UI_RUNTIME_EFFECT_DETAILS = Object.freeze({
    ...
    gladiatorFlurry: stacks => `${Math.floor(stacks || 0)}/12중첩 · 공격 속도 ${Math.floor(stacks || 0) * GLADIATOR_FLURRY_ATTACK_SPEED_AMP_PCT_PER_STACK}% 증폭 · 회피 +${Math.floor(stacks || 0) * GLADIATOR_FLURRY_EVASION_PCT_PER_STACK}%`,
