...
const BASE_ITEM_DB = [
    ...
    { id: 'woven_guard', slot: '방패', name: '직조 가드', reqTier: 4, baseStats: [{ id: 'evasion', base: 62 }, { id: 'baseBlockChance', base: 6 }] },
    { id: 'aegis_focus', slot: '방패', name: '아이기스 포커스', reqTier: 4, baseStats: [{ id: 'energyShield', base: 66 }, { id: 'baseBlockChance', base: 6.5 }] },
    { id: 'scale_guard', slot: '방패', name: '비늘 방패', reqTier: 4, baseStats: [{ id: 'armor', base: 58 }, { id: 'evasion', base: 56 }, { id: 'baseBlockChance', base: 5 }] },
    ...
    { id: 'runic_scale_guard', slot: '방패', name: '룬비늘 방패', reqTier: 12, baseStats: [{ id: 'armor', base: 112 }, { id: 'evasion', base: 108 }, { id: 'baseBlockChance', base: 4 }] },
    ...
    { id: 'archon_focus', slot: '방패', name: '아콘 초점패', reqTier: 16, baseStats: [{ id: 'energyShield', base: 166 }, { id: 'baseBlockChance', base: 3 }] },
    ...
    { id: 'gen__armor_t1', slot: '투구', name: '강철 투구 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 7 }, { id: 'armor', base: 26 }] },
    { id: 'gen__armor_t16', slot: '투구', name: '강철 투구 V', reqTier: 16, baseStats: [{ id: 'flatHp', base: 83 }, { id: 'armor', base: 307 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__armor_t20', slot: '투구', name: '강철 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 103 }, { id: 'armor', base: 383 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_t1', slot: '투구', name: '질풍 투구 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 5 }, { id: 'evasion', base: 17 }] },
    { id: 'gen__evasion_t4', slot: '투구', name: '질풍 투구 II', reqTier: 4, baseStats: [{ id: 'flatHp', base: 21 }, { id: 'evasion', base: 66 }] },
    { id: 'gen__evasion_t16', slot: '투구', name: '질풍 투구 V', reqTier: 16, baseStats: [{ id: 'flatHp', base: 72 }, { id: 'evasion', base: 240 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__evasion_t20', slot: '투구', name: '질풍 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 90 }, { id: 'evasion', base: 300 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__energyShield_t4', slot: '투구', name: '비전 투구 II', reqTier: 4, baseStats: [{ id: 'flatHp', base: 28 }, { id: 'energyShield', base: 93 }] },
    { id: 'gen__energyShield_t16', slot: '투구', name: '비전 투구 V', reqTier: 16, baseStats: [{ id: 'flatHp', base: 64 }, { id: 'energyShield', base: 320 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__energyShield_t20', slot: '투구', name: '비전 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 80 }, { id: 'energyShield', base: 400 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_evasion_t1', slot: '투구', name: '척후 투구 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 7 }, { id: 'armor', base: 11 }, { id: 'evasion', base: 11 }] },
    { id: 'gen__armor_evasion_t20', slot: '투구', name: '척후 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 104 }, { id: 'armor', base: 165 }, { id: 'evasion', base: 171 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_energyShield_t1', slot: '투구', name: '성전 투구 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 8 }, { id: 'armor', base: 15 }, { id: 'energyShield', base: 15 }] },
    { id: 'gen__armor_energyShield_t20', slot: '투구', name: '성전 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 115 }, { id: 'armor', base: 216 }, { id: 'energyShield', base: 229 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_energyShield_t1', slot: '투구', name: '월령 투구 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 6 }, { id: 'evasion', base: 10 }, { id: 'energyShield', base: 10 }] },
    { id: 'gen__evasion_energyShield_t20', slot: '투구', name: '월령 투구 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 99 }, { id: 'evasion', base: 157 }, { id: 'energyShield', base: 163 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_t1_1', slot: '갑옷', name: '강철 갑옷 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 11 }, { id: 'armor', base: 55 }] },
    { id: 'gen__armor_t12', slot: '갑옷', name: '강철 갑옷 IV', reqTier: 12, baseStats: [{ id: 'flatHp', base: 78 }, { id: 'armor', base: 368 }] },
    { id: 'gen__armor_t20_1', slot: '갑옷', name: '강철 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 123 }, { id: 'armor', base: 573 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_t4_1', slot: '갑옷', name: '질풍 갑옷 II', reqTier: 4, baseStats: [{ id: 'flatHp', base: 34 }, { id: 'evasion', base: 90 }] },
    { id: 'gen__evasion_t12', slot: '갑옷', name: '질풍 갑옷 IV', reqTier: 12, baseStats: [{ id: 'flatHp', base: 71 }, { id: 'evasion', base: 241 }] },
    { id: 'gen__evasion_t20_1', slot: '갑옷', name: '질풍 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 112 }, { id: 'evasion', base: 487 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__energyShield_t1', slot: '갑옷', name: '비전 갑옷 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 6 }, { id: 'energyShield', base: 27 }] },
    { id: 'gen__energyShield_t4_1', slot: '갑옷', name: '비전 갑옷 II', reqTier: 4, baseStats: [{ id: 'flatHp', base: 23 }, { id: 'energyShield', base: 109 }] },
    { id: 'gen__energyShield_t8', slot: '갑옷', name: '비전 갑옷 III', reqTier: 8, baseStats: [{ id: 'flatHp', base: 47 }, { id: 'energyShield', base: 218 }] },
    { id: 'gen__energyShield_t20_1', slot: '갑옷', name: '비전 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 101 }, { id: 'energyShield', base: 560 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_evasion_t1_1', slot: '갑옷', name: '척후 갑옷 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 11 }, { id: 'armor', base: 22 }, { id: 'evasion', base: 23 }] },
    { id: 'gen__armor_evasion_t20_1', slot: '갑옷', name: '척후 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 131 }, { id: 'armor', base: 259 }, { id: 'evasion', base: 269 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_energyShield_t1_1', slot: '갑옷', name: '성전 갑옷 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 12 }, { id: 'armor', base: 30 }, { id: 'energyShield', base: 24 }] },
    { id: 'gen__armor_energyShield_t20_1', slot: '갑옷', name: '성전 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 136 }, { id: 'armor', base: 317 }, { id: 'energyShield', base: 309 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_energyShield_t1_1', slot: '갑옷', name: '월령 갑옷 I', reqTier: 1, baseStats: [{ id: 'flatHp', base: 10 }, { id: 'evasion', base: 21 }, { id: 'energyShield', base: 18 }] },
    { id: 'gen__evasion_energyShield_t20_1', slot: '갑옷', name: '월령 갑옷 VI', reqTier: 20, baseStats: [{ id: 'flatHp', base: 120 }, { id: 'evasion', base: 243 }, { id: 'energyShield', base: 237 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_t1_2', slot: '장갑', name: '강철 장갑 I', reqTier: 1, baseStats: [{ id: 'aspd', base: 2 }, { id: 'flatHp', base: 4 }, { id: 'armor', base: 14 }] },
    { id: 'gen__armor_t8', slot: '장갑', name: '강철 장갑 III', reqTier: 8, baseStats: [{ id: 'aspd', base: 6 }, { id: 'flatHp', base: 20 }, { id: 'armor', base: 100 }] },
    { id: 'gen__armor_t16_1', slot: '장갑', name: '강철 장갑 V', reqTier: 16, baseStats: [{ id: 'aspd', base: 8 }, { id: 'flatHp', base: 32 }, { id: 'armor', base: 193 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__armor_t20_2', slot: '장갑', name: '강철 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'flatHp', base: 40 }, { id: 'armor', base: 242 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_t4_2', slot: '장갑', name: '질풍 장갑 II', reqTier: 4, baseStats: [{ id: 'aspd', base: 4 }, { id: 'evasion', base: 42 }] },
    { id: 'gen__evasion_t8', slot: '장갑', name: '질풍 장갑 III', reqTier: 8, baseStats: [{ id: 'aspd', base: 6 }, { id: 'evasion', base: 73 }] },
    { id: 'gen__evasion_t16_1', slot: '장갑', name: '질풍 장갑 V', reqTier: 16, baseStats: [{ id: 'aspd', base: 8 }, { id: 'evasion', base: 140 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__evasion_t20_2', slot: '장갑', name: '질풍 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'evasion', base: 175 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__energyShield_t1_1', slot: '장갑', name: '비전 장갑 I', reqTier: 1, baseStats: [{ id: 'aspd', base: 2 }, { id: 'energyShield', base: 11 }] },
    { id: 'gen__energyShield_t4_2', slot: '장갑', name: '비전 장갑 II', reqTier: 4, baseStats: [{ id: 'aspd', base: 4 }, { id: 'energyShield', base: 45 }] },
    { id: 'gen__energyShield_t8_1', slot: '장갑', name: '비전 장갑 III', reqTier: 8, baseStats: [{ id: 'aspd', base: 6 }, { id: 'energyShield', base: 90 }] },
    { id: 'gen__energyShield_t16_1', slot: '장갑', name: '비전 장갑 V', reqTier: 16, baseStats: [{ id: 'aspd', base: 8 }, { id: 'energyShield', base: 180 }, { id: 'resAll', base: 6 }] },
    { id: 'gen__energyShield_t20_2', slot: '장갑', name: '비전 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'energyShield', base: 225 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_evasion_t1_2', slot: '장갑', name: '척후 장갑 I', reqTier: 1, baseStats: [{ id: 'aspd', base: 2 }, { id: 'armor', base: 6 }, { id: 'evasion', base: 6 }] },
    { id: 'gen__armor_evasion_t20_2', slot: '장갑', name: '척후 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'armor', base: 99 }, { id: 'evasion', base: 104 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_energyShield_t1_2', slot: '장갑', name: '성전 장갑 I', reqTier: 1, baseStats: [{ id: 'aspd', base: 2 }, { id: 'armor', base: 8 }, { id: 'energyShield', base: 7 }] },
    { id: 'gen__armor_energyShield_t20_2', slot: '장갑', name: '성전 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'armor', base: 139 }, { id: 'energyShield', base: 136 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_energyShield_t1_2', slot: '장갑', name: '월령 장갑 I', reqTier: 1, baseStats: [{ id: 'aspd', base: 2 }, { id: 'evasion', base: 6 }, { id: 'energyShield', base: 5 }] },
    { id: 'gen__evasion_energyShield_t20_2', slot: '장갑', name: '월령 장갑 VI', reqTier: 20, baseStats: [{ id: 'aspd', base: 9 }, { id: 'evasion', base: 101 }, { id: 'energyShield', base: 96 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_t1_3', slot: '신발', name: '강철 장화 I', reqTier: 1, baseStats: [{ id: 'move', base: 6 }, { id: 'flatHp', base: 2 }, { id: 'armor', base: 14 }] },
    { id: 'gen__armor_t4', slot: '신발', name: '강철 장화 II', reqTier: 4, baseStats: [{ id: 'move', base: 10 }, { id: 'flatHp', base: 9 }, { id: 'armor', base: 55 }] },
    { id: 'gen__armor_t8_1', slot: '신발', name: '강철 장화 III', reqTier: 8, baseStats: [{ id: 'move', base: 14 }, { id: 'flatHp', base: 19 }, { id: 'armor', base: 109 }] },
    { id: 'gen__armor_t20_3', slot: '신발', name: '강철 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'flatHp', base: 48 }, { id: 'armor', base: 307 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_t1_1', slot: '신발', name: '질풍 장화 I', reqTier: 1, baseStats: [{ id: 'move', base: 6 }, { id: 'flatHp', base: 4 }, { id: 'evasion', base: 16 }] },
    { id: 'gen__evasion_t20_3', slot: '신발', name: '질풍 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'flatHp', base: 70 }, { id: 'evasion', base: 247 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__energyShield_t4_3', slot: '신발', name: '비전 장화 II', reqTier: 4, baseStats: [{ id: 'move', base: 10 }, { id: 'energyShield', base: 67 }] },
    { id: 'gen__energyShield_t12', slot: '신발', name: '비전 장화 IV', reqTier: 12, baseStats: [{ id: 'move', base: 17 }, { id: 'energyShield', base: 177 }] },
    { id: 'gen__energyShield_t20_3', slot: '신발', name: '비전 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'energyShield', base: 293 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_evasion_t1_3', slot: '신발', name: '척후 장화 I', reqTier: 1, baseStats: [{ id: 'move', base: 6 }, { id: 'armor', base: 9 }, { id: 'evasion', base: 9 }] },
    { id: 'gen__armor_evasion_t20_3', slot: '신발', name: '척후 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'armor', base: 128 }, { id: 'evasion', base: 136 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_energyShield_t1_3', slot: '신발', name: '성전 장화 I', reqTier: 1, baseStats: [{ id: 'move', base: 6 }, { id: 'armor', base: 12 }, { id: 'energyShield', base: 11 }] },
    { id: 'gen__armor_energyShield_t20_3', slot: '신발', name: '성전 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'armor', base: 168 }, { id: 'energyShield', base: 163 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_energyShield_t1_3', slot: '신발', name: '월령 장화 I', reqTier: 1, baseStats: [{ id: 'move', base: 6 }, { id: 'evasion', base: 9 }, { id: 'energyShield', base: 8 }] },
    { id: 'gen__evasion_energyShield_t20_3', slot: '신발', name: '월령 장화 VI', reqTier: 20, baseStats: [{ id: 'move', base: 23 }, { id: 'evasion', base: 136 }, { id: 'energyShield', base: 131 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_t20_4', slot: '방패', name: '강철 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'armor', base: 198 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_t1_2', slot: '방패', name: '질풍 방패 I', reqTier: 1, baseStats: [{ id: 'baseBlockChance', base: 7 }, { id: 'evasion', base: 16 }] },
    { id: 'gen__evasion_t20_4', slot: '방패', name: '질풍 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'evasion', base: 193 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__energyShield_t1_2', slot: '방패', name: '비전 방패 I', reqTier: 1, baseStats: [{ id: 'baseBlockChance', base: 7 }, { id: 'energyShield', base: 17 }] },
    { id: 'gen__energyShield_t20_4', slot: '방패', name: '비전 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'energyShield', base: 208 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_evasion_t1_4', slot: '방패', name: '척후 방패 I', reqTier: 1, baseStats: [{ id: 'baseBlockChance', base: 7 }, { id: 'armor', base: 15 }, { id: 'evasion', base: 14 }] },
    { id: 'gen__armor_evasion_t20_4', slot: '방패', name: '척후 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'armor', base: 178 }, { id: 'evasion', base: 170 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__armor_energyShield_t1_4', slot: '방패', name: '성전 방패 I', reqTier: 1, baseStats: [{ id: 'baseBlockChance', base: 7 }, { id: 'armor', base: 14 }, { id: 'energyShield', base: 14 }] },
    { id: 'gen__armor_energyShield_t20_4', slot: '방패', name: '성전 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'armor', base: 175 }, { id: 'energyShield', base: 168 }, { id: 'resAll', base: 9 }] },
    { id: 'gen__evasion_energyShield_t1_4', slot: '방패', name: '월령 방패 I', reqTier: 1, baseStats: [{ id: 'baseBlockChance', base: 7 }, { id: 'evasion', base: 14 }, { id: 'energyShield', base: 13 }] },
    { id: 'gen__evasion_energyShield_t20_4', slot: '방패', name: '월령 방패 VI', reqTier: 20, baseStats: [{ id: 'baseBlockChance', base: 2.6 }, { id: 'evasion', base: 170 }, { id: 'energyShield', base: 165 }, { id: 'resAll', base: 9 }] }
];
