...
const BASE_ITEM_DB = [
    ...
    { id: 'archon_familiar_staff', slot: '무기', name: '아콘 사역마 지팡이', reqTier: 16, baseStats: [{ id: 'flatDmg', base: 34 }, { id: 'summonPctDmg', base: 40 }, { id: 'summonEfficiency', base: 18 }] },
    ...
    { id: 'skypiercer_bow', slot: '무기', name: '하늘꿰뚫는 장궁', reqTier: 16, baseStats: [{ id: 'flatDmg', base: 39 }, { id: 'projectilePctDmg', base: 30 }] },
    { id: 'meteor_repeater', slot: '무기', name: '유성 연사 발리스타', reqTier: 17, baseStats: [{ id: 'flatDmg', base: 55 }, { id: 'projectilePctDmg', base: 34 }, { id: 'projectileExtraShots', base: 3 }] },
    { id: 'genesis_void_staff', slot: '무기', name: '창세 공허 지팡이', reqTier: 17, baseStats: [{ id: 'flatDmg', base: 34 }, { id: 'spellFlatDmg', base: 78 }, { id: 'spellFlatPct', base: 30 }] },
    { id: 'empyrean_familiar_staff', slot: '무기', name: '천상 사역마 지팡이', reqTier: 18, baseStats: [{ id: 'flatDmg', base: 41 }, { id: 'summonPctDmg', base: 50 }, { id: 'summonEfficiency', base: 22 }] },
